...
The complete `likelihood_ttbarZ_13TeV/4L_workspace.json` is unchanged.
This is the published four-lepton fit, not the combined three- and four-lepton fit.
It has five channels, five bins, and 182 parameters. No signal patch is needed.
