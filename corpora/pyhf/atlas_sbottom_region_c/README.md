...
`pyhf.json` applies patch `sbottom_1300_850_60` from `RegionC/patchset.json`
to `RegionC/BkgOnly.json` using `pyhf.PatchSet.apply`, including its digest check.
It retains every observation and constraint: 3 channels, 6 bins, 66 parameters.
