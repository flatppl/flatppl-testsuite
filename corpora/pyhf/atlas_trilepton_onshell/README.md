# ATLAS three-lepton search: on-shell WZ
...
`pyhf.json` applies patch `CN_WZ_250_50_harmonised_onshell`
from `2106.01676/onshell_winobino_plus_patchset.json` to
`2106.01676/bkg_onshell.json` using `pyhf.PatchSet.apply`, including its digest check.
